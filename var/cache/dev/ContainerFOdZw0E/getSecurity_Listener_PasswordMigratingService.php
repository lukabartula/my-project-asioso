...
class getSecurity_Listener_PasswordMigratingService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['security.listener.password_migrating'] = new \Symfony\Component\Security\Http\EventListener\PasswordMigratingListener(($container->privates['pimcore.security.password_hasher_factory'] ?? $container->load('getPimcore_Security_PasswordHasherFactoryService')));
    }
}
