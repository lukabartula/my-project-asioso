...
class getAssetController2Service extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/vendor/pimcore/admin-ui-classic-bundle/src/Controller/GDPR/AssetController.php';

        $container->services['Pimcore\\Bundle\\AdminBundle\\Controller\\GDPR\\AssetController'] = $instance = new \Pimcore\Bundle\AdminBundle\Controller\GDPR\AssetController();
        ...
        $instance->setContainer(($container->privates['.service_locator.CgLZdtH'] ?? $container->load('get_ServiceLocator_CgLZdtHService'))->withContext('Pimcore\\Bundle\\AdminBundle\\Controller\\GDPR\\AssetController', $container));
