 ...
 */
class getApp_Area_Brick_TextWithImageService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'app.area.brick.text_with_image' shared autowired service.
     *
     * @return \App\Document\Areabrick\TextWithImage
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Document/Areabrick/TextWithImage.php';

        $container->privates['app.area.brick.text_with_image'] = $instance = new \App\Document\Areabrick\TextWithImage();
