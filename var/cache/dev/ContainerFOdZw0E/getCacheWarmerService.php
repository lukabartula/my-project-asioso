...
class getCacheWarmerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['cache_warmer'] = new \Symfony\Component\HttpKernel\CacheWarmer\CacheWarmerAggregate(new RewindableGenerator(function () use ($container) {
            ...
            yield 8 => ($container->privates['webpack_encore.entrypoint_lookup.cache_warmer'] ??= new \Symfony\WebpackEncoreBundle\CacheWarmer\EntrypointCacheWarmer(['pimcoreAdmin' => (\dirname(__DIR__, 4).'/vendor/pimcore/admin-ui-classic-bundle/public/build/admin/entrypoints.json'), 'pimcoreAdminImageEditor' => (\dirname(__DIR__, 4).'/vendor/pimcore/admin-ui-classic-bundle/public/build/imageEditor/entrypoints.json')], NULL, ($container->targetDir.''.'/webpack_encore.cache.php')));
            yield 9 => ($container->privates['Pimcore\\HttpKernel\\CacheWarmer\\MkdirCacheWarmer'] ??= new \Pimcore\HttpKernel\CacheWarmer\MkdirCacheWarmer());
            yield 10 => ($container->privates['Pimcore\\HttpKernel\\CacheWarmer\\PimcoreCoreCacheWarmer'] ??= new \Pimcore\HttpKernel\CacheWarmer\PimcoreCoreCacheWarmer());
