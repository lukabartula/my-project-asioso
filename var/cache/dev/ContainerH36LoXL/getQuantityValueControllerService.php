...
class getQuantityValueControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/vendor/pimcore/admin-ui-classic-bundle/src/Controller/Admin/DataObject/QuantityValueController.php';
        include_once \dirname(__DIR__, 4).'/vendor/pimcore/pimcore/models/DataObject/QuantityValue/Service.php';

        $container->services['Pimcore\\Bundle\\AdminBundle\\Controller\\Admin\\DataObject\\QuantityValueController'] = $instance = new \Pimcore\Bundle\AdminBundle\Controller\Admin\DataObject\QuantityValueController(($container->privates['Pimcore\\Model\\DataObject\\QuantityValue\\Service'] ??= new \Pimcore\Model\DataObject\QuantityValue\Service()));
        ...
        $instance->setContainer(($container->privates['.service_locator.CgLZdtH'] ?? $container->load('get_ServiceLocator_CgLZdtHService'))->withContext('Pimcore\\Bundle\\AdminBundle\\Controller\\Admin\\DataObject\\QuantityValueController', $container));
