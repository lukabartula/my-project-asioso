...
class getConsole_Command_MessengerStatsService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->privates['console.command.messenger_stats'] = $instance = new \Symfony\Component\Messenger\Command\StatsCommand(($container->privates['messenger.receiver_locator'] ?? $container->load('getMessenger_ReceiverLocatorService')), ['pimcore_search_backend_message', 'pimcore_core', 'pimcore_maintenance', 'pimcore_scheduled_tasks', 'pimcore_image_optimize', 'pimcore_asset_update']);
