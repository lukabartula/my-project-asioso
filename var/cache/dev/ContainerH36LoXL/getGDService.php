...
class getGDService extends App_KernelDevDebugContainer
{
    ...
    {
        include_once \dirname(__DIR__, 4).'/vendor/pimcore/pimcore/lib/Image/AdapterInterface.php';
        ...
        $container->factories['Pimcore\\Image\\Adapter\\GD'] = function ($container) {
            return new \Pimcore\Image\Adapter\GD();
        };

        return $container->factories['Pimcore\\Image\\Adapter\\GD']($container);
    }
}
