...
class getMessenger_Transport_PimcoreScheduledTasksService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['messenger.transport.pimcore_scheduled_tasks'] = $a->createTransport('amqp://rabbitmq:5672/%2f/pimcore_scheduled_tasks', ['transport_name' => 'pimcore_scheduled_tasks'], ($container->privates['messenger.transport.native_php_serializer'] ??= new \Symfony\Component\Messenger\Transport\Serialization\PhpSerializer()));
    }
}
