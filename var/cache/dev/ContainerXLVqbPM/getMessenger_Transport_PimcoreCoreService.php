...
class getMessenger_Transport_PimcoreCoreService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['messenger.transport.pimcore_core'] = $a->createTransport('amqp://rabbitmq:5672/%2f/pimcore_core', ['transport_name' => 'pimcore_core'], ($container->privates['messenger.transport.native_php_serializer'] ??= new \Symfony\Component\Messenger\Transport\Serialization\PhpSerializer()));
    }
}
