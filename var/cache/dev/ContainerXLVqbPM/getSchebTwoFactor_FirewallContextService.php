...
class getSchebTwoFactor_FirewallContextService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['scheb_two_factor.firewall_context'] = new \Scheb\TwoFactorBundle\Security\TwoFactor\TwoFactorFirewallContext(['pimcore_admin' => ($container->privates['security.firewall_config.two_factor.pimcore_admin'] ?? self::getSecurity_FirewallConfig_TwoFactor_PimcoreAdminService($container))]);
    }
}
