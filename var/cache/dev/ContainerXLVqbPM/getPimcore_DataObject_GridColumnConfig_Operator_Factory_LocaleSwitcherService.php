...
class getPimcore_DataObject_GridColumnConfig_Operator_Factory_LocaleSwitcherService extends App_KernelDevDebugContainer
{
     ...
     *
     * @return \Pimcore\Bundle\AdminBundle\DataObject\GridColumnConfig\Operator\Factory\LocaleSwitcherFactory
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/vendor/pimcore/admin-ui-classic-bundle/src/DataObject/GridColumnConfig/Operator/Factory/LocaleSwitcherFactory.php';

        return $container->privates['pimcore.data_object.grid_column_config.operator.factory.locale_switcher'] = new \Pimcore\Bundle\AdminBundle\DataObject\GridColumnConfig\Operator\Factory\LocaleSwitcherFactory(($container->services['Pimcore\\Localization\\LocaleServiceInterface'] ?? self::getLocaleServiceInterfaceService($container)));
    }
}
