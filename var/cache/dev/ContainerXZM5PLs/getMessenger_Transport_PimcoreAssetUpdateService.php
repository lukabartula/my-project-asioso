 ...
 */
class getMessenger_Transport_PimcoreAssetUpdateService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'messenger.transport.pimcore_asset_update' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['messenger.transport.pimcore_asset_update'])) {
            return $container->privates['messenger.transport.pimcore_asset_update'];
        }

        return $container->privates['messenger.transport.pimcore_asset_update'] = $a->createTransport('amqp://rabbitmq:5672/%2f/pimcore_asset_update', ['transport_name' => 'pimcore_asset_update'], ($container->privates['messenger.transport.native_php_serializer'] ??= new \Symfony\Component\Messenger\Transport\Serialization\PhpSerializer()));
    }
}
