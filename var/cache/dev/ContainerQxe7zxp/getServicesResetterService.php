    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['services_resetter'] = new \Symfony\Component\HttpKernel\DependencyInjection\ServicesResetter(new RewindableGenerator(function () use ($container) {
            ...
            if (isset($container->privates['debug.security.firewall.authenticator.pimcore_webdav'])) {
                yield 'debug.security.firewall.authenticator.pimcore_webdav' => ($container->privates['debug.security.firewall.authenticator.pimcore_webdav'] ?? null);
            }
            if (isset($container->privates['debug.security.firewall.authenticator.pimcore_admin'])) {
                yield 'debug.security.firewall.authenticator.pimcore_admin' => ($container->privates['debug.security.firewall.authenticator.pimcore_admin'] ?? null);
            }
        ...
        }, fn () => 0 + (int) (isset($container->services['request_stack'])) + (int) (isset($container->services['cache.app'])) + (int) (isset($container->services['cache.system'])) + (int) (isset($container->privates['cache.validator'])) + (int) (isset($container->privates['cache.serializer'])) + (int) (isset($container->privates['cache.annotations'])) + (int) (isset($container->privates['cache.property_info'])) + (int) (isset($container->privates['cache.messenger.restart_workers_signal'])) + (int) (isset($container->privates['mailer.message_logger_listener'])) + (int) (isset($container->privates['translation.locale_switcher'])) + (int) (isset($container->services['debug.stopwatch'])) + (int) (isset($container->services['event_dispatcher'])) + (int) (isset($container->privates['debug.log_processor'])) + (int) (isset($container->privates['cache.rate_limiter'])) + (int) (isset($container->services['Symfony\\Component\\HttpKernel\\EventListener\\SessionListener'])) + (int) (isset($container->services['cache.validator_expression_language'])) + (int) (isset($container->privates['messenger.transport.in_memory.factory'])) + (int) (isset($container->services['.container.private.profiler'])) + (int) (isset($container->privates['debug.validator'])) + (int) (isset($container->privates['security.token_storage'])) + (int) (isset($container->privates['cache.security_expression_language'])) + (int) (isset($container->services['cache.security_is_granted_attribute_expression_language'])) + (int) (isset($container->privates['debug.security.firewall'])) + (int) (isset($container->privates['debug.security.firewall.authenticator.pimcore_webdav'])) + (int) (isset($container->privates['debug.security.firewall.authenticator.pimcore_admin'])) + (int) (isset($container->privates['twig'])) + (int) (isset($container->privates['monolog.handler.usage'])) + (int) (isset($container->privates['monolog.handler.redirect'])) + (int) (isset($container->privates['monolog.handler.main'])) + (int) (isset($container->privates['monolog.handler.error'])) + (int) (isset($container->privates['monolog.handler.console'])) + (int) (isset($container->services['doctrine'])) + (int) (isset($container->privates['doctrine.debug_data_holder'])) + (int) (isset($container->privates['webpack_encore.tag_renderer'])) + (int) (isset($container->privates['cache.webpack_encore'])) + (int) (isset($container->privates['webpack_encore.entrypoint_lookup[pimcoreAdmin]'])) + (int) (isset($container->privates['webpack_encore.entrypoint_lookup[pimcoreAdminImageEditor]'])) + (int) (isset($container->privates['Pimcore\\Bundle\\CoreBundle\\DataCollector\\PimcoreDataCollector'])) + (int) (isset($container->services['pimcore.cache.adapter.null_tag_aware'])) + (int) (isset($container->privates['pimcore.cache.adapter.doctrine_dbal'])) + (int) (isset($container->services['pimcore.cache.pool'])) + (int) (false)), ['request_stack' => ['?resetRequestFormats'], 'cache.app' => ['reset'], 'cache.system' => ['reset'], 'cache.validator' => ['reset'], 'cache.serializer' => ['reset'], 'cache.annotations' => ['reset'], 'cache.property_info' => ['reset'], 'cache.messenger.restart_workers_signal' => ['reset'], 'mailer.message_logger_listener' => ['reset'], 'translation.locale_switcher' => ['reset'], 'debug.stopwatch' => ['reset'], 'debug.event_dispatcher' => ['reset'], 'debug.log_processor' => ['reset'], 'cache.rate_limiter' => ['reset'], 'session_listener' => ['reset'], 'cache.validator_expression_language' => ['reset'], 'messenger.transport.in_memory.factory' => ['reset'], 'profiler' => ['reset'], 'debug.validator' => ['reset'], 'security.token_storage' => ['disableUsageTracking', 'setToken'], 'cache.security_expression_language' => ['reset'], 'cache.security_is_granted_attribute_expression_language' => ['reset'], 'debug.security.firewall' => ['reset'], 'debug.security.firewall.authenticator.pimcore_webdav' => ['reset'], 'debug.security.firewall.authenticator.pimcore_admin' => ['reset'], 'twig' => ['resetGlobals'], 'monolog.handler.usage' => ['reset'], 'monolog.handler.redirect' => ['reset'], 'monolog.handler.main' => ['reset'], 'monolog.handler.error' => ['reset'], 'monolog.handler.console' => ['reset'], 'doctrine' => ['reset'], 'doctrine.debug_data_holder' => ['reset'], 'webpack_encore.tag_renderer' => ['reset'], 'cache.webpack_encore' => ['reset'], 'webpack_encore.entrypoint_lookup[pimcoreAdmin]' => ['reset'], 'webpack_encore.entrypoint_lookup[pimcoreAdminImageEditor]' => ['reset'], 'Pimcore\\Bundle\\CoreBundle\\DataCollector\\PimcoreDataCollector' => ['reset'], 'pimcore.cache.adapter.null_tag_aware' => ['reset'], 'pimcore.cache.adapter.doctrine_dbal' => ['reset'], 'pimcore.cache.adapter.doctrine_dbal_tag_aware' => ['reset'], 'pimcore.cache.pool.app' => ['reset']]);
    }
}
