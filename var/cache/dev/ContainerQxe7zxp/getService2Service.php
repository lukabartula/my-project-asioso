...
{
    /**
     * Gets the public 'Pimcore\Bundle\AdminBundle\DataObject\GridColumnConfig\Service' shared autowired service.
     *
     * @return \Pimcore\Bundle\AdminBundle\DataObject\GridColumnConfig\Service
     */
    public static function do($container, $lazyLoad = true)
    {
        include_once \dirname(__DIR__, 4).'/vendor/pimcore/admin-ui-classic-bundle/src/DataObject/GridColumnConfig/Service.php';

        return $container->services['Pimcore\\Bundle\\AdminBundle\\DataObject\\GridColumnConfig\\Service'] = new \Pimcore\Bundle\AdminBundle\DataObject\GridColumnConfig\Service(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
