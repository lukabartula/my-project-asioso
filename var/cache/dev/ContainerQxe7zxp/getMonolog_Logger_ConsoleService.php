 ...
 */
class getMonolog_Logger_ConsoleService extends App_KernelDevDebugContainer
{
    /**
    ...
    {
        $container->services['monolog.logger.console'] = $instance = new \Monolog\Logger('console');
