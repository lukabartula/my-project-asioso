 ...
 */
class getMonolog_Logger_SessionService extends App_KernelDevDebugContainer
{
    /**
    ...
    {
        $container->services['monolog.logger.session'] = $instance = new \Monolog\Logger('session');
