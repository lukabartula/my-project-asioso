...
class PimcoreConfig implements \Symfony\Component\Config\Builder\ConfigBuilderInterface
{
    ...
    */
    ...
    /**
     * @default {"image_thumbnails":{"write_target":{"type":"symfony-config","options":{"directory":"\/var\/www\/html\/var\/config\/image_thumbnails"}}},"video_thumbnails":{"write_target":{"type":"symfony-config","options":{"directory":"\/var\/www\/html\/var\/config\/video_thumbnails"}}},"document_types":{"write_target":{"type":"symfony-config","options":{"directory":"\/var\/www\/html\/var\/config\/document_types"}}},"predefined_properties":{"write_target":{"type":"symfony-config","options":{"directory":"\/var\/www\/html\/var\/config\/predefined_properties"}}},"predefined_asset_metadata":{"write_target":{"type":"symfony-config","options":{"directory":"\/var\/www\/html\/var\/config\/predefined_asset_metadata"}}},"perspectives":{"write_target":{"type":"symfony-config","options":{"directory":"\/var\/www\/html\/var\/config\/perspectives"}}},"custom_views":{"write_target":{"type":"symfony-config","options":{"directory":"\/var\/www\/html\/var\/config\/custom_views"}}},"object_custom_layouts":{"write_target":{"type":"symfony-config","options":{"directory":"\/var\/www\/html\/var\/config\/object_custom_layouts"}}},"system_settings":{"write_target":{"type":"symfony-config","options":{"directory":"\/var\/www\/html\/var\/config\/system_settings"}},"read_target":{"type":null,"options":{"directory":null}}},"select_options":{"write_target":{"type":"symfony-config","options":{"directory":"\/var\/www\/html\/var\/config\/select_options"}},"read_target":{"type":null,"options":{"directory":null}}}}
    */
    ...
    public function __construct(array $value = [])
    {
        ...
        if (array_key_exists('dependency', $value)) {
            $this->_usedProperties['dependency'] = true;
            $this->dependency = new \Symfony\Config\Pimcore\DependencyConfig($value['dependency']);
