...
class DocumentConfig 
{
    ...
    */
    ...
    /**
     * @default 'only-unsafe'
     * @param ParamConfigurator|'all-pdfs'|'only-unsafe'|'none' $value
     * @return $this
     */
    public function openPdfInNewTab($value): static
    {
        $this->_usedProperties['openPdfInNewTab'] = true;
        $this->openPdfInNewTab = $value;
    ...
    public function __construct(array $value = [])
    {
        ...
        if (array_key_exists('open_pdf_in_new_tab', $value)) {
            $this->_usedProperties['openPdfInNewTab'] = true;
            $this->openPdfInNewTab = $value['open_pdf_in_new_tab'];
            unset($value['open_pdf_in_new_tab']);
        }
    ...
    public function toArray(): array
    {
        ...
        if (isset($this->_usedProperties['openPdfInNewTab'])) {
            $output['open_pdf_in_new_tab'] = $this->openPdfInNewTab;
        }
