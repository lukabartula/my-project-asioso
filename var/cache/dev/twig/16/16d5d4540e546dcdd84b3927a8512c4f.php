...
class __TwigTemplate_25db836f78aced8a3844730750c993f2 extends Template
{
...
";
    ...
    public function block_lead(array $context, array $blocks = []): iterable
    {
        ...
        // line 2
        yield $this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, (isset($context["email"]) || array_key_exists("email", $context) ? $context["email"] : (function () { throw new RuntimeError('Variable "email" does not exist.', 2, $this->source); })()), "subject", [], "any", false, false, true, 2), 2, $this->source);
        yield "
";
    ...
    public function block_content(array $context, array $blocks = []): iterable
    {
        ...
        // line 6
        yield $this->sandbox->ensureToStringAllowed((isset($context["content"]) || array_key_exists("content", $context) ? $context["content"] : (function () { throw new RuntimeError('Variable "content" does not exist.', 6, $this->source); })()), 6, $this->source);
        yield "
";
    ...
    public function block_action(array $context, array $blocks = []): iterable
    {
        ...
        if ((isset($context["action_url"]) || array_key_exists("action_url", $context) ? $context["action_url"] : (function () { throw new RuntimeError('Variable "action_url" does not exist.', 10, $this->source); })())) {
            // line 11
            yield $this->sandbox->ensureToStringAllowed((isset($context["action_text"]) || array_key_exists("action_text", $context) ? $context["action_text"] : (function () { throw new RuntimeError('Variable "action_text" does not exist.', 11, $this->source); })()), 11, $this->source);
            yield ": ";
            yield $this->sandbox->ensureToStringAllowed((isset($context["action_url"]) || array_key_exists("action_url", $context) ? $context["action_url"] : (function () { throw new RuntimeError('Variable "action_url" does not exist.', 11, $this->source); })()), 11, $this->source);
            yield "
";
        }
...
";
            // line 18
            yield $this->sandbox->ensureToStringAllowed((isset($context["exception"]) || array_key_exists("exception", $context) ? $context["exception"] : (function () { throw new RuntimeError('Variable "exception" does not exist.', 18, $this->source); })()), 18, $this->source);
            yield "
";
        }
    ...
    {
        return array (  181 => 18,  178 => 17,  176 => 16,  163 => 15,  147 => 11,  145 => 10,  132 => 9,  119 => 6,  106 => 5,  93 => 2,  80 => 1,  69 => 15,  66 => 14,  64 => 9,  61 => 8,  59 => 5,  56 => 4,  54 => 1,);
    }
...
{% endif %}
{% endblock %}
", "@email/zurb_2/notification/body.txt.twig", "/var/www/html/vendor/symfony/twig-bridge/Resources/views/Email/zurb_2/notification/body.txt.twig");
    }
    
    public function checkSecurity()
    {
        static $tags = ["block" => 1, "if" => 10];
        static $filters = [];
        static $functions = [];
