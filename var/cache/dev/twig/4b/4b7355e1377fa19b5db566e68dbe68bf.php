...
class __TwigTemplate_58b4a19ad53f6c5978f755faf68c1d7d extends Template
{
    ...
    <div class=\"page\" id=\"documentpage-";
        // line 4
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, (isset($context["document"]) || array_key_exists("document", $context) ? $context["document"] : (function () { throw new RuntimeError('Variable "document" does not exist.', 4, $this->source); })()), "id", [], "any", false, false, true, 4), 4, $this->source), "html", null, true);
        yield "\">
...
";
    ...
    <div class=\"page\" id=\"documentpage-{{ document.id }}\">
...
{% endblock %}
", "web2print/default_no_layout.html.twig", "/var/www/html/templates/web2print/default_no_layout.html.twig");
    }
