...
class __TwigTemplate_6050e306487b19cfe8bfee73e5c64e5d extends Template
{
...
<pre>";
        // line 9
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->sandbox->ensureToStringAllowed((isset($context["log"]) || array_key_exists("log", $context) ? $context["log"] : (function () { throw new RuntimeError('Variable "log" does not exist.', 9, $this->source); })()), 9, $this->source));
        yield "</pre>
</body>
</html>'
";
...
", "@PimcoreAdmin/admin/email/text.html.twig", "/var/www/html/vendor/pimcore/admin-ui-classic-bundle/templates/admin/email/text.html.twig");
    }
